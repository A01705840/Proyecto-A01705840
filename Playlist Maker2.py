...
def nueva_cancion(nueva_canc):
    ...
    devuelve: la playlist con las canciones previamente añadidas y la nueva canción
    """
...
def quitar_cancion(no_canc):
    ...
    devuelve: la playlist con las canciones previamente añadidas, pero sin la canción eliminada
    """
